...
export function Hero() {
    return (
        <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
            ...
            {/* Content */}
            <div className="flex flex-col items-center text-center pt-32 md:pt-40 pb-[var(--spacing-section-pb-desktop)] px-6 max-w-[900px] mx-auto max-md:pb-[var(--spacing-section-pb-mobile)]">
                {/* Badge */}
